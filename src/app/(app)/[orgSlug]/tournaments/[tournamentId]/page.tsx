  ...
  return (
    <section className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6">
      ...
      <ModulePageHeader
        ...
        description={`${tournament.season} · manage settings and team enrollment.`}
        actions={
        ...
        <TabsContent value="settings">
          {access.canManageStaff ? (
            ...
            <dl className="grid max-w-lg gap-4 border border-[#D0D5DB] bg-white p-5 text-sm">
              <div>
                <dt className="font-medium text-[#5C6570]">Season</dt>
                <dd className="mt-1 font-mono text-[#0A0A0A]">
                  {tournament.season}
                </dd>
              </div>
              <div>
                <dt className="font-medium text-[#5C6570]">Format</dt>
                <dd className="mt-1 text-[#0A0A0A]">{tournament.format}</dd>
              </div>
              <div>
                <dt className="font-medium text-[#5C6570]">Status</dt>
                <dd className="mt-1 text-[#0A0A0A]">{tournament.status}</dd>
              </div>
            </dl>
          )}
        </TabsContent>
